...
if __name__ == "__main__":
    ...
    command_str = f"python3 main.py --inst-file {test_case_dir}/instMem.txt --data-file {test_case_dir}/dataMem.txt --reg-file {test_case_dir}/register.txt"  # Command string with script and arguments
